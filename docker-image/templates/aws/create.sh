...
echo ""
echo "To create the server infrastructure:"
echo ""
echo "  terraform init terraform"
echo "  terraform apply terraform"
echo ""
echo "The last command will automatically generate the Ansible"
echo "inventory. Then, to configure the servers, run:"
echo ""
